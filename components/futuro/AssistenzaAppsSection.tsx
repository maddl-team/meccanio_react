import { assistenzaApps } from "@/data/futuro";
import styles from "./futuro.module.css";

export function AssistenzaAppsSection() {
  return (
    <section id="ambiti" className={styles.apps} aria-labelledby="ambiti-assistenza-title">
      ...
      <div className={styles.appsInner}>
        <div className={styles.appsHead}>
          <div className={styles.appsIntro}>
            ...
            <h2 id="ambiti-assistenza-title" className={styles.appsTitle}>
