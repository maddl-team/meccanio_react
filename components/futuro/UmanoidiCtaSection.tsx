...
export function UmanoidiCtaSection() {
  return (
    <section id="contatti" className={styles.cta} aria-labelledby="contatti-umanoidi-title">
      <div className={styles.ctaCard}>
        <div>
          <h2 id="contatti-umanoidi-title" className={styles.ctaTitle}>
