import { quadrupediApps } from "@/data/futuro";
import styles from "./futuro.module.css";

export function QuadrupediAppsSection() {
  return (
    <section id="ambiti" className={styles.apps} aria-labelledby="ambiti-quadrupedi-title">
      ...
      <div className={styles.appsInner}>
        <div className={styles.appsHead}>
          <div className={styles.appsIntro}>
            ...
            <h2 id="ambiti-quadrupedi-title" className={styles.appsTitle}>
